        ...
        <header>
            ...
            <div>
                <div id="ResposiveHeader">
                    ...
                    <button><a href='https://drive.google.com/uc?export=view&id=1PMaHBO4ZdWk5vPmwZritqht52KJ7SMx1' target='_blank' rel="noreferrer">Download Resume</a></button>
                </div>
            </div>
            <ul>
                ...
                <li><a href='https://drive.google.com/uc?export=view&id=1PMaHBO4ZdWk5vPmwZritqht52KJ7SMx1' target='_blank' rel="noreferrer">RESUME</a></li>
            </ul>
